...
$source = Join-Path $projectRoot "src\hwbp_zero_gap_observer_v1.cpp"
...
$output = Join-Path $outputDir "a9tas_hwbp_zero_gap_observer_v1"
...
if ($LASTEXITCODE -ne 0) { throw "zero-gap observer build failed" }
