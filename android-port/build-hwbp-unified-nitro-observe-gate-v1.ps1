...
$output = Join-Path $root "build\staging\a9tas_hwbp_unified_nitro_observe_gate_v1"
...
$arguments = @(
    ...
    "-Wall", "-Wextra", "-Werror",
    "-DA9TAS_UNIFIED_NITRO_RPC_V1=1",
    "-DA9TAS_UNIFIED_NITRO_OBSERVE_GATE_V1=1",
    $source, "-o", $output
)
& $compiler @arguments
if ($LASTEXITCODE -ne 0) {
    throw "unified nitro observe gate build failed (exit=$LASTEXITCODE)"
}
