...
void DumpDispatchList(std::uintptr_t guest_base, const char* name,
    ...
    std::memcpy(&begin, reinterpret_cast<const void*>(list_addr), sizeof(begin));
    std::memcpy(&end, reinterpret_cast<const void*>(list_addr + 8), sizeof(end));
    ...
    for (size_t i = 0; i < count; ++i) {
        ...
        std::memcpy(&raw, reinterpret_cast<const void*>(begin + 8 + i * 16),
                    sizeof(raw));
        std::memcpy(&vtable, reinterpret_cast<const void*>(raw), sizeof(vtable));
        std::memcpy(&cb, reinterpret_cast<const void*>(vtable + 0x10), sizeof(cb));
        ...
        std::memcpy(&obj28, reinterpret_cast<const void*>(raw + 0x28), sizeof(obj28));
        std::memcpy(&step, reinterpret_cast<const void*>(obj28 + 0xb0), sizeof(step));
        std::memcpy(&obj250, reinterpret_cast<const void*>(raw + 0x250), sizeof(obj250));
        std::memcpy(&v2, reinterpret_cast<const void*>(obj250 + 0x60), sizeof(v2));
        __android_log_print(ANDROID_LOG_INFO, kTag,
                            "    %s sub[%zu] cb=0x%llx(off 0x%llx) obj28=0x%llx "
                            "step=0x%llx(off 0x%llx) obj250=0x%llx v2=0x%llx(off 0x%llx)",
                            ...
                            static_cast<unsigned long long>(step - guest_base),
                            static_cast<unsigned long long>(obj250),
                            static_cast<unsigned long long>(v2),
                            static_cast<unsigned long long>(v2 - guest_base));
    }
}
