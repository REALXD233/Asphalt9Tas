#ifndef A9TAS_HABI1_DEVICE_PAYLOAD_PATH
#error "A9TAS_HABI1_DEVICE_PAYLOAD_PATH must be provided by the pinned build"
#endif
#ifndef A9TAS_HABI1_PAYLOAD_SHA256
#error "A9TAS_HABI1_PAYLOAD_SHA256 must be provided by the pinned build"
#endif
#ifndef A9TAS_HABI1_PAYLOAD_BUILD_ID
#error "A9TAS_HABI1_PAYLOAD_BUILD_ID must be provided by the pinned build"
#endif
#ifndef A9TAS_HABI1_PAYLOAD_SOURCE_SHA256
#error "A9TAS_HABI1_PAYLOAD_SOURCE_SHA256 must be provided by the pinned build"
#endif

#define A9TAS_HABI1_BOOTSTRAP_STRINGIFY_INNER(value) #value
#define A9TAS_HABI1_BOOTSTRAP_STRINGIFY(value) \
    A9TAS_HABI1_BOOTSTRAP_STRINGIFY_INNER(value)

#define A9TAS_ENABLE_SAME_THREAD_PROBE 1
#define A9TAS_ENABLE_UNSAFE_LATE_ARM_LOAD 0
#define A9TAS_PAYLOAD_PATH \
    A9TAS_HABI1_BOOTSTRAP_STRINGIFY(A9TAS_HABI1_DEVICE_PAYLOAD_PATH)
#define A9TAS_SAME_THREAD_PROBE_SYMBOL \
    "a9tas_hook_abi_selftest_habi1_run"
// JNI shorty: jlong return plus one explicit jlong nonce argument.  The
// implicit JNIEnv*/jobject pair is part of the NativeBridge trampoline ABI.
...
static_assert(offsetof(Habi1BootstrapLocator, stage_address) == 456);
static_assert(offsetof(Habi1BootstrapLocator, return_trap_address) == 496);
...
Habi1BootstrapLocator a9tas_bootstrap_hook_abi_selftest_habi1_locator = {
    ...
    A9TAS_HABI1_BOOTSTRAP_STRINGIFY(A9TAS_HABI1_DEVICE_PAYLOAD_PATH),
    A9TAS_HABI1_BOOTSTRAP_STRINGIFY(A9TAS_HABI1_PAYLOAD_SHA256),
    A9TAS_HABI1_BOOTSTRAP_STRINGIFY(A9TAS_HABI1_PAYLOAD_BUILD_ID),
    A9TAS_HABI1_BOOTSTRAP_STRINGIFY(A9TAS_HABI1_PAYLOAD_SOURCE_SHA256),
