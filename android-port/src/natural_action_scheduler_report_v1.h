...
namespace a9tas::natural_action_scheduler_report_v1 {

using PayloadControl = natural_action_lifecycle_report_v1::PayloadControl;
...
using CleanupDisposition =
    natural_action_lifecycle_report_v1::CleanupDisposition;
...
struct Report {
    ...
    std::uint64_t action_receipt_ns;
...
static_assert(sizeof(Report) == 664);
static_assert(offsetof(Report, action_receipt_ns) == 232);
static_assert(offsetof(Report, action_frames) == 312);
