...
$source = Join-Path $projectRoot "src\nitro_command_path_observer_v1.cpp"
...
$output = Join-Path $outputDir "a9tas_nitro_command_observer_v1"
...
if ($LASTEXITCODE -ne 0) { throw "nitro command observer v1 build failed" }
