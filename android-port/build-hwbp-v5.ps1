...
$source = Join-Path $projectRoot "src\hwbp_event_observer_v5.cpp"
...
$output = Join-Path $outputDir "a9tas_hwbp_observer_v5"
...
if ($LASTEXITCODE -ne 0) { throw "HWBP v5 observer build failed" }
