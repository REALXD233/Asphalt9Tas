...
$output = Join-Path $outputDirectory "a9tas_hwbp_natural_action_until_release_recorder_v1"
...
if ($LASTEXITCODE -ne 0) {
    throw "natural action-until-release recorder build failed (exit=$LASTEXITCODE)"
}
