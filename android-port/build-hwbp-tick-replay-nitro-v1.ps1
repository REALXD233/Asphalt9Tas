...
$source = Join-Path $projectRoot "src\hwbp_tick_replay_nitro_v1.cpp"
...
$output = Join-Path $outputDir "a9tas_hwbp_tick_replay_nitro_v1"
...
if ($LASTEXITCODE -ne 0) { throw "HWBP nitro replay v1 build failed" }
