...
$output = Join-Path $outputDirectory "a9tas_hwbp_natural_preroll_brake_replay_v1"
...
$arguments = @(
    ...
    "-Wall", "-Wextra", "-Werror",
    "-DA9TAS_REPLAY_ALIGNMENT_GUARD_V1",
    "-DA9TAS_NATURAL_PREROLL_REPLAY_V1",
    "-DA9TAS_UNIFIED_BRAKE_V1",
    $source, "-o", $output
)
& $compiler @arguments
if ($LASTEXITCODE -ne 0) {
    throw "natural pre-roll brake replay build failed (exit=$LASTEXITCODE)"
}
